    ...
    <div className="flex-1 flex justify-center items-center py-12 px-4 bg-base-200/50">
      <div className="card w-full max-w-md bg-base-100 shadow-2xl border border-base-200">
        <div className="card-body">
          <h2 className="text-3xl font-extrabold text-center mb-6 text-base-content">Welcome Back</h2>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="form-control">
              ...
              <label className="input input-bordered flex items-center gap-2 focus-within:outline-[#E45C04]">
            ...
            <button type="submit" className="btn bg-[#E45C04] hover:bg-[#c44b03] text-white border-none w-full mt-4 font-bold shadow-lg shadow-[#E45C04]/30">
              <LogIn size={18} /> Login
            </button>
          </form>
          ...
          <p className="text-center text-sm mt-4 text-base-content/70">
            Don&apos;t have an account? <Link href="/register" className="text-[#E45C04] hover:underline font-bold">Register here</Link>
          </p>
        </div>
      </div>
    </div>
